 ...
 *
 ****************************************************************************/
#ifndef __BF3905__SENSOR_H
#define __BF3905__SENSOR_H
...
*/
 ...
 #define SYSTEM_CLK                           (52*1000*1000)
  ...
  #define PIXEL_CLK							    (SYSTEM_CLK/8)		// 52/8 MHz
   ...
   #define BF3905MIPI_VIDEO_NORMALMODE_FRAME_RATE							30		// Limitation for MPEG4 Encode Only
   #define BF3905MIPI_VIDEO_NIGHTMODE_FRAME_RATE							15
	/* SENSOR PIXEL/LINE NUMBERS IN ONE PERIOD */
	#define BF3905_VGA_PERIOD_PIXEL_NUMS					784
	#define BF3905_VGA_PERIOD_LINE_NUMS					510

	/* SENSOR EXPOSURE LINE LIMITATION */
	#define VGA_EXPOSURE_LIMITATION					510

	/* SENSOR GLOBAL GAIN AT NIGHT MODE */
	#define BF3905MIPI_SENSOR_NIGHT_MODE_GAIN					0x08	// Please refer to OV7670 Implementation Guide
	
	/* SENSOR VGA SIZE */
	#define BF3905_IMAGE_SENSOR_VGA_WIDTH					(640-8)
	#define BF3905_IMAGE_SENSOR_VGA_HEIGHT					(480-6)


    #define BF3905_IMAGE_SENSOR_FULL_WIDTH          (640-8) 
    #define BF3905_IMAGE_SENSOR_FULL_HEIGHT         (480-6) 

    #define BF3905_IMAGE_SENSOR_PV_WIDTH   BF3905_IMAGE_SENSOR_VGA_WIDTH
    #define BF3905_IMAGE_SENSOR_PV_HEIGHT  BF3905_IMAGE_SENSOR_VGA_HEIGHT
    
	/* SETUP TIME NEED TO BE INSERTED */
	#define BF3905_IMAGE_SENSOR_VGA_INSERTED_PIXELS		128
	#define BF3905_IMAGE_SENSOR_VGA_INSERTED_LINES		    17
	
	#define BF3905MIPI_WRITE_ID								0xdc
	#define BF3905MIPI_READ_ID								0xdd

struct BF3905MIPI_Sensor_Struct
{
