...
void OV5645MIPIInitialSetting(void)
{
  ...
  OV5645MIPI_write_cmos_sensor(0x3004, 0xef);
	...
	OV5645MIPI_write_cmos_sensor(0x5385, 0x69);//
	OV5645MIPI_write_cmos_sensor(0x5386, 0x6c);//
	OV5645MIPI_write_cmos_sensor(0x5387, 0x77);//
	OV5645MIPI_write_cmos_sensor(0x5388, 0x6d);//
