...
/*
  ...
  OV5645MIPI_write_cmos_sensor(0x5189, 0x64);//5e
  OV5645MIPI_write_cmos_sensor(0x518a, 0x5c);//5c
  ...
  */
	...
	OV5645MIPI_write_cmos_sensor(0x5382, 0x54);
	OV5645MIPI_write_cmos_sensor(0x5383, 0x15);
	OV5645MIPI_write_cmos_sensor(0x5384, 0x07);
	OV5645MIPI_write_cmos_sensor(0x5385, 0x6a);
	OV5645MIPI_write_cmos_sensor(0x5386, 0x71);
	OV5645MIPI_write_cmos_sensor(0x5387, 0x75);
	...
	OV5645MIPI_write_cmos_sensor(0x583d, 0xce);//ae
...
static void OV5645MIPIFullSizeCaptureSetting(void)
{
	...
	*/
	...
	OV5645MIPI_write_cmos_sensor(0x5303, 0x08);
	OV5645MIPI_write_cmos_sensor(0x5306, 0x06);
	OV5645MIPI_write_cmos_sensor(0x5307, 0x3f);
	if(run_test_potten)
	{
		run_test_potten=0;
		OV5645SetTestPatternMode(1);
